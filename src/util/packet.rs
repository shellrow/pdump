...
pub fn get_ethertype_string(ethertype: EtherType) -> String {
    match ethertype {
        ...
        EtherTypes::PBridge => {return String::from("Provider Bridging");},
...
pub fn get_icmp_type_string(icmptype: IcmpType) -> String {
    match icmptype {
        ...
        IcmpTypes::ParameterProblem => {return String::from("Parameter Problem");},
        ...
        IcmpTypes::RouterSolicitation => {return String::from("Router Solicitation");},
